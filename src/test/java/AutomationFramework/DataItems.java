...
public class DataItems {
    ...
    public static String anglerTestIndonesiaCustomer = "Angler Test Indonesia";
    public static String starGarmentsCustomer = "Star Garments Ltd.";
    ...
    public static String salesOrgID51 = "ID51";
    public static String salesOrgLK53 = "LK53";
    public static String brandASTRA = "ASTRA";
