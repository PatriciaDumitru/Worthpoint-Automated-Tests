...
public class CustomFactory {
    ...
    public static void identifyTests() throws InterruptedException, IOException, AWTException, Exception {
    ...
    public static void createManualEntryTest(Node METest) throws InterruptedException, IOException, Exception {
    ...
    public static void createUploadOrderTest(Node UOTest) throws IOException, AWTException, InterruptedException, Exception {
