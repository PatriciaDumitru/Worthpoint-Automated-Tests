...
public class Master_Test extends DriverFactory {
    ...
    //Most Solo tests will have the following structure:
    ...
    @Test //Approver User Type :: User type can be found and used in Solo
    (groups = {"Solo"})
    ...
    (groups = {"Solo"},enabled = false) //WBA Issue: Shade not deleted from table when delete pressed
    ...
    (groups = {"Solo"}, enabled = false) //DISABLED as data cannot be deleted from table (due to sharing violation) so test cannot pass
    ...
    (groups = {"Solo",}, enabled=false) //DISABLED as the data created cannot be deleted and so the test cannot pass.
    ...
    public void customerPrivateArticle() throws Exception {
        ...
        AssertJUnit.assertTrue("Customer Private Articles Page: Title not as expected",pPage.getBreadcrumb().getText().equals("Customer Private Articles"));
        ...
        AssertJUnit.assertTrue("Add Customer Private Articles.: Title not as expected",addPage.getBreadcrumb().getText().equals("Customer Private Atricles | Add Customer Private Atricles"));
        ...
        AssertJUnit.assertTrue("Customer Private Articles Page: Title not as expected",editPage.getBreadcrumb().getText().equals("Customer Private Articles | Edit Customer Private Articles"));
