...
public class Ecomm_ME_Exceptions_Test extends DriverFactory {
    ...
    public void MEex1() throws Exception {
        ...
        Ecomm_MainPage eCommPage = susstTest4.SUSST_SetUp("MANUAL ENTRY Exceptions ME_Ex1: Your Material Number not available","GE_OC_ME_Ex1");
    ...
    public void MEex2() throws Exception {
        ...
        Ecomm_Base susstTest4 = new Ecomm_Base(driver);
        //Set up returns a manual entry page to begin data entry
        Ecomm_MainPage eCommPage = susstTest4.SUSST_SetUp("MANUAL ENTRY Exceptions ME_Ex2: SUSST Missing Material (YMN/Shade)","GE_OC_ME_Ex2");
