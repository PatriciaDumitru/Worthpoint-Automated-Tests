...
public class Ecomm_ME_SUMST_Test extends DriverFactory {
    ...
    @Test //Manual Entry Page :: SUMST :: Sub-account test. Field appears and data included in Flat File
            (groups = {"eComm", "eComm_Orders"})
    //Konwn issue: order does not appear in pending approval page as it takes a while to be processed. Fix: wait and reload page, then check for order again
    ...
    public void SUSST_OA_OAP() throws Exception {
        ...
        //new base test to handle set up
        Ecomm_Base sumstTest = new Ecomm_Base(driver);
        //Set up returns an eComm main page
        Ecomm_MainPage eCommPage = sumstTest.setUp("MANUAL ENTRY SUMST12: Check validation at Confirmation Page (no requester)", "OA_OAP_SUSS_ME_1-5", validCoatsUsername2, validCoatsPassword);
        ...
        System.out.println("Confirmation page reached... Confirming...");
    ...
    public void SUMST_OA_OAP() throws Exception {
        ...
        Ecomm_Base sumstTest = new Ecomm_Base(driver);
        //Set up returns an eComm main page
        Ecomm_MainPage eCommPage = sumstTest.setUp("MANUAL ENTRY SUMST12: Check validation at Confirmation Page (no requester)", "OA_OAP_SUMS_ME_1-5", validCoatsUsername2, validCoatsPassword);
