...
public class Cce_Base {
    ...
    public CCE_MainPage setUp(String testTitle,String scenarioID) {
    ...
    public CCE_MainPage setUp(String testTitle,String scenarioID,String username, String password) {
        System.out.println("TEST: "+testTitle);
        System.out.println("Scenario ID: "+scenarioID);
