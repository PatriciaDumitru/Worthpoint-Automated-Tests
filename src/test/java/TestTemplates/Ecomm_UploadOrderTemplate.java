...
public class Ecomm_UploadOrderTemplate extends DriverFactory {
    
    public Ecomm_UploadOrderTemplate(String[] testDetails,String[] custDetails,String[] mapDetails) throws IOException, AWTException, InterruptedException, Exception {
        runTest(testDetails,custDetails,mapDetails);
    }
    
    public void runTest(String[] testDetails, String[] custDetails, String[] mapDetails) throws IOException, AWTException, InterruptedException, Exception {
        ...
        FileUtils.copyFile(scrFile1,new File(DataItems.screenshotsFilepath+"\\Custom Tests\\"+testDetails[0]+"\\1Upload Order Page.png"));
        ...
        if (testDetails[4].equals("true")) {
            ...
            FileUtils.copyFile(scrFile2,new File(DataItems.screenshotsFilepath+"\\Custom Tests\\"+testDetails[0]+"\\2Upload in Realtime.png"));
        } else {
            uoPage.pressBackend();
            System.out.println("Backend selected. Uploading...");
            //Take a screenshot
            File scrFile2 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
            FileUtils.copyFile(scrFile2,new File(DataItems.screenshotsFilepath+"\\Custom Tests\\"+testDetails[0]+"\\2Upload in Backend.png"));
        }
        ...
        if (testDetails[5].equals("true")) {
            ...
            FileUtils.copyFile(scrFile3,new File(DataItems.screenshotsFilepath+"\\Custom Tests\\"+testDetails[0]+"\\3Mapping alert.png"));
            ...
            //Take a screenshot
            File scrFile4 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
            FileUtils.copyFile(scrFile4,new File(DataItems.screenshotsFilepath+"\\Custom Tests\\"+testDetails[0]+"\\5Mapping confirmed.png"));
            ...
            FileUtils.copyFile(scrFile6,new File(DataItems.screenshotsFilepath+"\\Custom Tests\\"+testDetails[0]+"\\6Order submitted.png"));
        ...
        FileUtils.copyFile(scrFile7,new File(DataItems.screenshotsFilepath+"\\Custom Tests\\"+testDetails[0]+"\\6Order view.png"));
