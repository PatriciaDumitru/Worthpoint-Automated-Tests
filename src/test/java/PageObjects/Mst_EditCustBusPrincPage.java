...
public class Mst_EditCustBusPrincPage extends WBA_BasePage {
    
    public Mst_EditCustBusPrincPage(WebDriver driver) {
        super(driver);
    }
    ...
    public Mst_AddCustBusPrincPage setCoatsBusPrinc(String item) throws InterruptedException {
        CommonTask.setInputField(driver, coatsPrincipalNameField, item);
        return new Mst_AddCustBusPrincPage(driver);
    }
