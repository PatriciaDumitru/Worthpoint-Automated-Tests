...
public class Mst_EditChargedProductPage extends WBA_BasePage {
    ...
    By cancelButton = By.cssSelector("#ChargedProductEditForm > div.actions > ul > li:nth-child(2) > a");
    
    public Mst_EditChargedProductPage(WebDriver driver) {
        super(driver);
    }
    ...
    public Mst_EditChargedProductPage setSalesOrg(String item) throws InterruptedException {
        CommonTask.setDropDownField(driver,salesOrgField,item);
        return new Mst_EditChargedProductPage(driver);
    }
     
    public Mst_EditChargedProductPage setBrand(String item) throws InterruptedException {
        CommonTask.setDropDownField(driver,brandField,item);
        return new Mst_EditChargedProductPage(driver);
    }
    
    public Mst_EditChargedProductPage setTicket(String item) throws InterruptedException {
        CommonTask.setDropDownField(driver,ticketField,item);
        return new Mst_EditChargedProductPage(driver);
    }
    
    public Mst_EditChargedProductPage setMUMType(String item) throws InterruptedException {
        CommonTask.setDropDownField(driver,mumTypeField,item);
        return new Mst_EditChargedProductPage(driver);
    }
    
    public Mst_EditChargedProductPage setQuantity(String item) throws InterruptedException {
