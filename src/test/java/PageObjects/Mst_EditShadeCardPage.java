...
public class Mst_EditShadeCardPage extends WBA_BasePage {
    
    By shadeCardNameField = By.id("ShadeCardShadeCardName");
    By shadeCardCodeField = By.id("ShadeCardShadeCardCode");
    By saveButton = By.cssSelector("#ShadeCardEditForm > div.actions > ul > li:nth-child(1) > input[type=\"submit\"]");
    By cancelButton = By.cssSelector("#ShadeCardEditForm > div.actions > ul > li:nth-child(2) > a");
    
    public Mst_EditShadeCardPage(WebDriver driver) {
        super(driver);
    }
    ...
    public Mst_EditShadeCardPage setShadeCardName(String item) {
        WebElement element = new WebDriverWait(driver,DataItems.shortWait).until(ExpectedConditions.elementToBeClickable(shadeCardNameField));
        element.clear();
    ...
    public Mst_EditShadeCardPage setShadeCardCode(String item) {
