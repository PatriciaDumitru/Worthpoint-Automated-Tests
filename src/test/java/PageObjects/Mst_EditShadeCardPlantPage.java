...
public class Mst_EditShadeCardPlantPage extends WBA_BasePage {
    ...
    By saveButton = By.cssSelector("#ShadeCardsPlantEditForm > div.actions > ul > li:nth-child(1) > input[type=\"submit\"]");
    By cancelButton = By.cssSelector("#ShadeCardsPlantEditForm > div.actions > ul > li:nth-child(2) > a");
    
    public Mst_EditShadeCardPlantPage(WebDriver driver) {
        super(driver);
    }
    ...
    public Mst_EditShadeCardPlantPage setShadeCardCode(String item) throws InterruptedException {
        CommonTask.setDropDownField(driver, shadeCardCodeField, item);
        return new Mst_EditShadeCardPlantPage(driver);
    }
    
    public Mst_EditShadeCardPlantPage setPlantName(String item) throws InterruptedException {
        CommonTask.setDropDownField(driver, plantNameField, item);
        return new Mst_EditShadeCardPlantPage(driver);
    }
    
    public Mst_EditShadeCardPlantPage setBrand(String item) throws InterruptedException {
