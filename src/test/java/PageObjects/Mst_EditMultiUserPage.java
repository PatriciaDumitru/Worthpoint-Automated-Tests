...
public class Mst_EditMultiUserPage extends WBA_BasePage {
    ...
    By cancelButton = By.cssSelector("#MultiUserEditForm > div.actions > ul > li:nth-child(2) > a");
    
    public Mst_EditMultiUserPage(WebDriver driver) {
        super(driver);
    }
    ...
    public Mst_AddMultiUserPage setCustomerName(String item) throws InterruptedException {
        CommonTask.setDropDownFieldAlt(driver, customerNameField, item);
        return new Mst_AddMultiUserPage(driver);
    }
    
    public Mst_AddMultiUserPage setShipToParty(String item) throws InterruptedException {
        CommonTask.setDropDownFieldAlt(driver, shipToPartyField, item);
        return new Mst_AddMultiUserPage(driver);
    }
