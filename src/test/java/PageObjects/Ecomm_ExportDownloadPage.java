...
public class Ecomm_ExportDownloadPage {
    ...
    public void waitForDownloadCompletion() {
        Boolean waitForInvisibility = new WebDriverWait(driver,DataItems.downloadWait).ignoring(NoSuchElementException.class).until(ExpectedConditions.textToBePresentInElement(frameLocator, "100% Completed"));
    }
