...
public class Mst_EditCustBrandPage extends WBA_BasePage {
    ...
    By saveButton = By.cssSelector("#CustomerBrandEditForm > div.actions > ul > li:nth-child(1) > input[type=\"submit\"]");
    By cancelButton = By.cssSelector("#CustomerBrandEditForm > div.actions > ul > li:nth-child(2) > a");
    
    public Mst_EditCustBrandPage(WebDriver driver) {
        super(driver);
    }
    ...
    public Mst_AddCustBrandPage setCustName(String item) throws InterruptedException {
        CommonTask.setSearchField(driver, custNameField, item);
        return new Mst_AddCustBrandPage(driver);
    }
    
    public Mst_AddCustBrandPage setCustomerBrand(String item) throws InterruptedException {
        WebElement element = new WebDriverWait(driver,DataItems.shortWait).until(ExpectedConditions.elementToBeClickable(custBrandField));
        element.clear();
