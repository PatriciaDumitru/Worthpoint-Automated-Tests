...
public class Ecomm_SummaryOfPurchasePage extends WBA_BasePage {
    ...
    public void checkFields() {
        ...
        WebElement waitForPurFrom = new WebDriverWait(driver,5).until(ExpectedConditions.elementToBeClickable(purchaseDateFromField));
        WebElement waitForPurTo = new WebDriverWait(driver,5).until(ExpectedConditions.elementToBeClickable(purchaseDateToField));
