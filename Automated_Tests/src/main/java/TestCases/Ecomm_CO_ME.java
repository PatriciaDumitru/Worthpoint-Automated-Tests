...
public class Ecomm_CO_ME {
  ...
  private By overlayContent = By.cssSelector("#BulkOrderLineViewUplodErrorListForm > div.grid_12 > div.grid_12");
  ...
  @Test
  public void testEcommContractOrderManualEntry() throws Exception {
    driver.get(baseUrl + "/");
    ...
    FileUtils.copyFile(scrFile1,new File(TestSuite.screenshotsFilepath+"\\EComm\\Orders\\Manual Entry\\Contract Order\\1Manual Entry Page CO.png"));
    ...
    FileUtils.copyFile(scrFile2,new File(TestSuite.screenshotsFilepath+"\\EComm\\Orders\\Manual Entry\\Contract Order\\2Cust Details entered CO.png"));
    ...
    //CommonTask.waitForFieldUpdate(driver, lineRefField, TestSuite.conOrdLineRef);
    //Take a screenshot
    File scrFile3 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
    FileUtils.copyFile(scrFile3,new File(TestSuite.screenshotsFilepath+"\\EComm\\Orders\\Manual Entry\\Contract Order\\3Material details entered CO.png"));
    ...
    FileUtils.copyFile(scrFile4,new File(TestSuite.screenshotsFilepath+"\\EComm\\Orders\\Manual Entry\\Contract Order\\Confirmation page CO.png"));
    driver.findElement(By.linkText("Line with Error")).click();
    CommonTask.waitForOverlay(driver,overlayContent);
    //Take a screenshot
    File scrFile5 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
    FileUtils.copyFile(scrFile5,new File(TestSuite.screenshotsFilepath+"\\EComm\\Orders\\Manual Entry\\Contract Order\\Error line view CO.png"));
