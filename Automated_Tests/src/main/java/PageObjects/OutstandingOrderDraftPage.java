...
import static PageObjects.ManualEntryPage.customerNameField;
 ...
 * @author ukspjsykes
 */
public class OutstandingOrderDraftPage extends BasePage {
    ...
    public OutstandingOrderDraftPage(WebDriver passedDriver) {
        super(passedDriver);
    }
   
    public OutstandingOrderDraftPage setCustName(String custName) {       
    ...
    public OutstandingOrderDraftPage setOrderNo(String orderNo) {
    ...
    public OutstandingOrderDraftPage setPONumber(String poNumber) {
        //Wait for field
    ...
    public OutstandingOrderDraftPage setBrand(String brand) {
    ...
    public OutstandingOrderDraftPage pressSearch() {
    ...
    public ManualEntryPage pressEdit() {
    ...
    public OutstandingOrderDraftPage closeView() {
    ...
    public OutstandingOrderDraftPage pressCancel() {
