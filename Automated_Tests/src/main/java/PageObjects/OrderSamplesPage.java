...
public class OrderSamplesPage {
    ...
    public OrderSamplesPage(WebDriver passedDriver) {
        driver = passedDriver;
    }
    ...
    public OrderSamplesPage setCustName(String custName) {
        CommonTask.setSearchField(driver,custNameFieldLocator,custName);
        return this;
    }
    
    public OrderSamplesPage setCustCode(String custCode) {
        CommonTask.setSearchField(driver, custCodeFieldLocator, custCode);
        return this;
    }
    
    public OrderSamplesPage setRequestor(String requestorName) throws InterruptedException {
    ...
    public AddOrderPage pressSubmit() {
