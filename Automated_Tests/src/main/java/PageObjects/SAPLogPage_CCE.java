...
public class SAPLogPage_CCE extends BasePage {
    ...
    public SAPLogPage_CCE(WebDriver passedDriver) {
        super(passedDriver);
    }
    ...
    public SAPLogPage_CCE setSalesOrg(String item) {
        CommonTask.setChoiceField(driver, salesOrgField, item);
        return this;
    }
    
    public SAPLogPage_CCE setArticle(String item) {
        CommonTask.setChoiceField(driver, articleField, item);
        return this;
    }
    
    public SAPLogPage_CCE setBusPrinc(String item) {
        CommonTask.setChoiceField(driver, busPrincField, item);
        return this;
    }
    
    public SAPLogPage_CCE setOrderNo(String item) {
        CommonTask.setSearchField(driver, orderNoField, item);
        return this;
    }
    
    public SAPLogPage_CCE setCustName(String item) {
        CommonTask.setSearchField(driver, custNameField, item);
        return this;
    }
    
    public SAPLogPage_CCE setShadeCode(String item) {
        CommonTask.setSearchField(driver, shadeCodeField, item);
        return this;
    }
    
    public SAPLogPage_CCE setMUMType(String item) {
        CommonTask.setSearchField(driver, mumTypeField, item);
        return this;
    }
    
    public SAPLogPage_CCE setSapStatus(String item) {
        CommonTask.setSearchField(driver, sapStatusField, item);
        return this;
    }
    
    public SAPLogPage_CCE pressSearch() {
    ...
    public SAPLogPage_CCE pressReset() {
    ...
    public void checkFields() {
        ...
        WebElement waitForBusprinc = new WebDriverWait(driver,10).until(ExpectedConditions.elementToBeClickable(busPrincField));
        ...
        WebElement waitForSapSO = new WebDriverWait(driver,10).until(ExpectedConditions.elementToBeClickable(sapSOField));
        ...
        Assert.assertTrue("SAP Log Page: Sales Organisation Field not displayed",getSalesOrgField().isDisplayed());
        Assert.assertTrue("SAP Log Page: Customer Code Field not displayed",getCustCodeField().isDisplayed());
        Assert.assertTrue("SAP Log Page: Article Field not displayed",getArticleField().isDisplayed());
        Assert.assertTrue("SAP Log Page: Order No Field not displayed",getOrderNoField().isDisplayed());
        Assert.assertTrue("SAP Log Page: Business Principal Field not displayed",getBusPrincField().isDisplayed());
        Assert.assertTrue("SAP Log Page: Order Date From Field not displayed",getOrderDateFromField().isDisplayed());
        Assert.assertTrue("SAP Log Page: Order Date To Field not displayed",getOrderDateToField().isDisplayed());
        Assert.assertTrue("SAP Log Page: Customer Name Field not displayed",getCustNameField().isDisplayed());
        Assert.assertTrue("SAP Log Page: Shade Code Field not displayed",getShadeCodeField().isDisplayed());
        Assert.assertTrue("SAP Log Page: MUM Type Field not displayed",getMUMTypeField().isDisplayed());
        Assert.assertTrue("SAP Log Page: SAP Status Field not displayed",getSapStatusField().isDisplayed());
        Assert.assertTrue("SAP Log Page: SAP SO# Field not displayed",getSapSOField().isDisplayed());
        Assert.assertTrue("SAP Log Page: Order Line Field not displayed",getOrderLineField().isDisplayed());
        Assert.assertTrue("SAP Log Page: Ship To Party Code Field not displayed",getShipToCodeField().isDisplayed());
        Assert.assertTrue("SAP Log Page: Search button not displayed",getSearchButton().isDisplayed());
        Assert.assertTrue("SAP Log Page: Reset button not displayed",getResetButton().isDisplayed());
        Assert.assertTrue("SAP Log Page: Export button not displayed",getExportButton().isDisplayed());
    }
}
