...
public class ManualEntryPage extends BasePage {
    ...
    public ManualEntryPage deleteRow(int lineNumber) {
    ...
    public ManualEntryPage setCustomerName(String customerName) {
    ...
    public ManualEntryPage setShipToParty(String shipToParty) {
    ...
    public ManualEntryPage setRequestor(String requestor) {
    ...
    public ManualEntryPage setBuyers(String buyer) {
    ...
    public ManualEntryPage setPoNumber(String poNumber) {
    ...
    public ManualEntryPage setYourMaterialNumber(String yourMaterialNumber,int lineNumber) {
    ...
    public ManualEntryPage setArticle(String article,int lineNumber) {
    ...
    public ManualEntryPage setBrand(String brand, int lineNumber) {
    ...
    public ManualEntryPage setTicket(String ticket,int lineNumber) {
        //Produce locator for field
    ...
    public ManualEntryPage setLength(String length, int lineNumber) {
        //Produce locator for field
    ...
    public ManualEntryPage setFinish(String finish, int lineNumber) {
        //Produce locator for field
        By finishLocator = By.id("Finish"+lineNumber);
    ...
    public ManualEntryPage setShadeCode(String shadeCode,int lineNumber) {
        //produce locator for field. Line numbers start from 0
    ...
    public ManualEntryPage setQty(int quantity, int lineNumber) {
        //produce locator for field. Line numbers start from 0
    ...
    public ManualEntryPage setDate(int lineNumber) {
        //produce locator for field. Line numbers start from 0
    ...
    public ManualEntryPage setOrderDetailsYMN(String[] details,int lineNumber) {
        //Wait for field to be available
    ...
    public ManualEntryPage setOrderDetailsYMNShadeCode(String[] details, int lineNumber) {
        //Wait for field to be available
        WebElement waitForClickable = new WebDriverWait(driver,10).until(ExpectedConditions.elementToBeClickable(By.id("materialno_"+lineNumber)));
        setYourMaterialNumber(details[0],lineNumber);
    ...
    public ManualEntryPage setOrderDetailsArticle(String[] details,int lineNumber) {
    ...
    public ManualEntryPage setOrderDetailsCombination(String[] details, int lineNumber) {
    ...
    public OrderConfirmationPage pressNext() {
