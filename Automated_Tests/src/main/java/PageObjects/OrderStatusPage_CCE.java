...
public class OrderStatusPage_CCE extends BasePage {
    ...
    public OrderStatusPage_CCE setOrderNo(String item) {
        CommonTask.setSearchField(driver, orderNoField, item);
        
        return this;
    } 
    
    public OrderStatusPage_CCE setCustName(String item) {
        CommonTask.setSearchField(driver, custNameField, item);
        
        return this;
    } 
    
    public OrderStatusPage_CCE setOrderStage(String item) {
        CommonTask.setSearchField(driver, orderStageField, item);
        
        return this;
    } 
    
    public OrderStatusPage_CCE setShadeCode(String item) {
    ...
    public OrderStatusPage_CCE pressListOrders() {
    ...
    public OrderStatusPage_CCE pressReset() {
    ...
    public OrderViewPage_CCE pressView(int lineNumber) {
        //Form locator
