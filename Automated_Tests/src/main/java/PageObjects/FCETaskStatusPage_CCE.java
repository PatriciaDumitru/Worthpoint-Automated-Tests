...
public class FCETaskStatusPage_CCE extends BasePage {
    ...
    public FCETaskStatusPage_CCE(WebDriver passedDriver) {
        super(passedDriver);
    }
    ...
    public FCETaskStatusPage_CCE setSalesOrg(String item) {
        CommonTask.setChoiceField(driver,salesOrgField,item);
        return this;
    }
    
    public FCETaskStatusPage_CCE setCustName(String item) {
    ...
    public FCETaskStatusPage_CCE setHub(String item) {
        CommonTask.setChoiceField(driver,hubField,item);
        return this;
    }
    
    public FCETaskStatusPage_CCE setTaskType(String item) {
        CommonTask.setChoiceField(driver,taskTypeField,item);
        return this;
    }
    
    public FCETaskStatusPage_CCE setFceName(String item) {
    ...
    public FCETaskStatusPage_CCE setTaskStatus(String item) {
