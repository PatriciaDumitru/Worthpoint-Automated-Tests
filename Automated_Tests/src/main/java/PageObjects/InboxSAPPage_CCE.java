...
public class InboxSAPPage_CCE extends BasePage {
    ...
    public InboxSAPPage_CCE(WebDriver passedDriver) {
        super(passedDriver);
    }
    ...
    public InboxSAPPage_CCE setOrderNo(String item) {
        CommonTask.setSearchField(driver,orderNoField,item);
        return this;
    }
    
    public InboxSAPPage_CCE setHub(String item) {
        CommonTask.setSearchField(driver,hubField,item);
        return this;
    }
    
    public InboxSAPPage_CCE setCustCode(String item) {
        CommonTask.setSearchField(driver,custCodeField,item);
        return this;
    }
    
    public InboxSAPPage_CCE setSalesOrg(String item) {
        CommonTask.setSearchField(driver,salesOrgField,item);
        return this;
    }
    
    public InboxSAPPage_CCE setRequester(String item) {
        CommonTask.setSearchField(driver,requesterField,item);
        return this;
    }
    
    public InboxSAPPage_CCE pressListOrders() {
    ...
    public InboxSAPPage_CCE pressReset() {
