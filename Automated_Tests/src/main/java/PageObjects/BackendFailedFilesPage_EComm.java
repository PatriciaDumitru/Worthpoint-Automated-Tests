...
public class BackendFailedFilesPage_EComm extends BasePage {
    ...
    public BackendFailedFilesPage_EComm(WebDriver driver) {
        super(driver);
    }
