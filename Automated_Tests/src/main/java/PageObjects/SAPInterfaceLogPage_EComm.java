...
public class SAPInterfaceLogPage_EComm extends BasePage {
	...
	public SAPInterfaceLogPage_EComm(WebDriver passedDriver) {
		super(passedDriver);
	}
	...
	public SAPInterfaceLogPage_EComm setCustPO(String item) {
		CommonTask.setTextField(driver, custPOField, item);
		
		return this;
	}
	
	public SAPInterfaceLogPage_EComm setYourMatNum(String item) {
		CommonTask.setTextField(driver, yourMatNumField, item);
		
		return this;
	}
	
	public SAPInterfaceLogPage_EComm setTicket(String item) {
		CommonTask.setSearchField(driver, ticketField, item);
		
		return this;
	}
	
	public SAPInterfaceLogPage_EComm setFinish(String item) {
		CommonTask.setSearchField(driver, finishField, item);
		
		return this;
	}
	
	public SAPInterfaceLogPage_EComm setSAPMessage(String item) {
		CommonTask.setSearchField(driver, sapMsgField, item);
		
		return this;
	}
	
	public SAPInterfaceLogPage_EComm setOrderNo(String item) {
		CommonTask.setSearchField(driver, orderNoField, item);
		
		return this;
	}
	
	public SAPInterfaceLogPage_EComm setBrand(String item) {
		CommonTask.setSearchField(driver, brandField, item);
		
		return this;
	}
	
	public SAPInterfaceLogPage_EComm setArticle(String item) {
		CommonTask.setTextField(driver, articleField, item);
		
		return this;
	}
	
	public SAPInterfaceLogPage_EComm setLength(String item) {
		CommonTask.setTextField(driver, lengthField, item);
		
		return this;
	}
	
	public SAPInterfaceLogPage_EComm setShadeCode(String item) {
		CommonTask.setTextField(driver, shadeCodeField, item);
		
		return this;
	}

	public SAPInterfaceLogPage_EComm setSalesOrg(String item) {
		CommonTask.setTextField(driver, salesOrgField, item);
		
		return this;
	}

	public SAPInterfaceLogPage_EComm pressSearch() {
	...
	public SAPInterfaceLogPage_EComm pressReset() {
	...
	public OrderViewPage pressFtView() {
	...
	public void checkFields() {
		...
		WebElement waitForCreationFrom = new WebDriverWait(driver,10).until(ExpectedConditions.elementToBeClickable(createDateFromField));
		...
		WebElement waitForSAPMsg = new WebDriverWait(driver,10).until(ExpectedConditions.elementToBeClickable(sapMsgField));
		...
		WebElement waitForFtView = new WebDriverWait(driver,10).until(ExpectedConditions.elementToBeClickable(ftViewButton));
