...
public class ConfirmProductionPage_CCE extends BasePage {
    ...
    public ConfirmProductionPage_CCE(WebDriver passedDriver) {
        super(passedDriver);
    }
    ...
    public ConfirmProductionPage_CCE setOrderNo(String item) {
        CommonTask.setSearchField(driver, orderNoField, item);
        return this;
    }
    
    public ConfirmProductionPage_CCE setFceName(String item) {
        CommonTask.setChoiceField(driver, fceNameField, item);
        return this;
    }
    
    public ConfirmProductionPage_CCE setRequestType(String item) {
        CommonTask.setSearchField(driver, requestTypeField, item);
        return this;
    }
    
    public ConfirmProductionPage_CCE setShipToName(String item) {
        CommonTask.setChoiceField(driver, shipToNameField, item);
        return this;
    }
    
    public ConfirmProductionPage_CCE setShipToCode(String item) {
        CommonTask.setChoiceField(driver, shipToCodeField, item);
        return this;
    }
    
    public ConfirmProductionPage_CCE setHub(String item) {
        CommonTask.setChoiceField(driver, hubField, item);
        return this;
    }
    
    public ConfirmProductionPage_CCE setScenario(String item) {
        CommonTask.setSearchField(driver, scenarioField, item);
        return this;
    }
    
    public ConfirmProductionPage_CCE setCustName(String item) {
        CommonTask.setChoiceField(driver, custNameField, item);
        return this;
    }
    
    public ConfirmProductionPage_CCE setFinalSOS(String item) {
        CommonTask.setSearchField(driver, finalSOSField, item);
        return this;
    }
    
    public ConfirmProductionPage_CCE setFinalShade(String item) throws InterruptedException {
        CommonTask.setDropDownField(driver, finalShadeField, item);
        return this;
    }
    
    public ConfirmProductionPage_CCE setMUMType(String item) throws InterruptedException {
        CommonTask.setDropDownField(driver, MUMTypeField, item);
        return this;
    }
    
    public ConfirmProductionPage_CCE setQtyProd(String item) {
        //Wait for clickable
    ...
    public ConfirmProductionPage_CCE setSendTo(String item) throws InterruptedException {
        CommonTask.setDropDownField(driver, sendToField, item);
        return this;
    }
    
    public ConfirmProductionPage_CCE pressListOrders() {
        //Wait for element
    ...
    public ConfirmProductionPage_CCE pressReset() {
        //Wait for element
    ...
    public ConfirmProductionPage_CCE pressConfirm() {
        //Wait for element
    ...
    public OrderViewPage_CCE pressDnPrint() {
    ...
    public ConfirmProductionPage_CCE pressSave() {
    ...
    public ConfirmProductionPage_CCE pressCancel() {
