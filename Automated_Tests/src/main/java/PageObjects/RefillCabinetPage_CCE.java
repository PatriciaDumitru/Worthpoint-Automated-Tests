...
public class RefillCabinetPage_CCE extends BasePage {
    ...
    public RefillCabinetPage_CCE(WebDriver passedDriver) {
        super(passedDriver);
    }
    ...
    public RefillCabinetPage_CCE setShipTo(String item) {
        CommonTask.setSearchField(driver, shipToPartyField, item);
        return this;
    }
    
    public RefillCabinetPage_CCE setCabinetName(String item) {
        CommonTask.setSearchField(driver, cabinetNameField, item);
        return this;
    }
    
    public RefillCabinetPage_CCE pressCancel() {
    ...
    public void checkFields() {
        ...
        Assert.assertTrue("Refill Cabinet Page: Cabinet name field not displayed correctly",getCabinetNameField().isDisplayed());
        Assert.assertTrue("Refill Cabinet Page: Submit button not displayed correctly",getSubmitButton().isDisplayed());
        Assert.assertTrue("Refill Cabinet Page: Cancel button not displayed correctly",getCancelButton().isDisplayed());
