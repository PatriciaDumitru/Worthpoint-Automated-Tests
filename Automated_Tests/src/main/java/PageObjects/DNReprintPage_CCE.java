...
public class DNReprintPage_CCE extends BasePage {
    ...
    public DNReprintPage_CCE(WebDriver passedDriver) {
        super(passedDriver);
    }
    ...
    public DNReprintPage_CCE setOrderNumber(String orderNumber) {
        CommonTask.setSearchField(driver, orderNumberLocator, orderNumber);
        return this;
    }
    
    public DNReprintPage_CCE setShipToPartyName(String shipToName) {
        CommonTask.setChoiceField(driver,shipToPartyNameLocator,shipToName);
        return this;
    }
    
    public DNReprintPage_CCE setShipToPartyCode(String shipToCode) {
        CommonTask.setChoiceField(driver,shipToPartyCodeLocator,shipToCode);
        return this;
    }
    
    public DNReprintPage_CCE setRequesterName(String requester) {
    ...
    public void checkFields() {
        ...
        WebElement waitForOrderNo = new WebDriverWait(driver,10).until(ExpectedConditions.elementToBeClickable(orderNumberLocator));
        WebElement waitForShipToCode = new WebDriverWait(driver,10).until(ExpectedConditions.elementToBeClickable(shipToPartyCodeLocator));
        WebElement waitForShipToName = new WebDriverWait(driver,10).until(ExpectedConditions.elementToBeClickable(shipToPartyNameLocator));
        WebElement waitForRequester = new WebDriverWait(driver,10).until(ExpectedConditions.elementToBeClickable(requesterNameLocator));
    ...
    public void pressConfirm() {
        //Wait for checkbox
        WebElement waitForVisible = new WebDriverWait(driver,10).until(ExpectedConditions.visibilityOfElementLocated(confirmButton));
    ...
    public DNPrintPage_CCE pressPrint() {
        ...
        return new DNPrintPage_CCE(driver);
    }
