...
public class Ecomm_AddOrderPage extends WBA_BasePage {
    ...
    public Ecomm_AddOrderPage(WebDriver passedDriver) {
       super(passedDriver);
    } 
    ...
    public Ecomm_AddOrderPage setShipToParty(String shipToParty) throws InterruptedException {
        CommonTask.setDropDownField(driver, shipToPartyField, shipToParty);
        return this;
    }
    
    public Ecomm_AddOrderPage setBusinessPrincipal(String businessPrincipal) throws InterruptedException {
        CommonTask.setDropDownField(driver, busPrincipalField, businessPrincipal);
        return this;
    }
    
    public Ecomm_AddOrderPage setArticle(String article, int lineNumber) {
    ...
    public Ecomm_AddOrderPage setBrand(String brand, int lineNumber) throws InterruptedException {
    ...
    public Ecomm_AddOrderPage setTicket(String ticket, int lineNumber) throws InterruptedException {
    ...
    public Ecomm_AddOrderPage setShadeCode(String shadeCode,int lineNumber) {
        //Line numbers start from 0
    ...
    public Ecomm_AddOrderPage setMUMType(String mumType, int lineNumber) {
        //line numbers start from 0
    ...
    public Ecomm_AddOrderPage setRequestType(String reqType, int lineNumber) {
        //Line numbers start from 0
    ...
    public Ecomm_AddOrderPage setPurposeType(String purpType, int lineNumber) throws InterruptedException {
        //Line numbers start from 0
    ...
    public Ecomm_AddOrderPage setQuantity(int quantity, int lineNumber) {
        //Line numbers start from 0
    ...
    public Ecomm_AddOrderPage pressCopy(int lineNumber) {
