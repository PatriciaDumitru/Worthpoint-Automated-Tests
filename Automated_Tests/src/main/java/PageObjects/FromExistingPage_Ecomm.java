...
public class FromExistingPage_Ecomm extends BasePage {
    ...
    public FromExistingPage_Ecomm(WebDriver passedDriver) {
        super(passedDriver);
    }
    ...
    public FromExistingPage_Ecomm setCustPo(String poNumber) {
    ...
    public FromExistingPage_Ecomm setOrderNo(String orderNo) {
        CommonTask.setSearchField(driver, orderNoFieldLocator, orderNo);
        return this;
    }
    
    public FromExistingPage_Ecomm setYmn(String ymn) {
        //Wait for element to be available and enter ymn
        WebElement waitForElement = new WebDriverWait(driver,10).until(ExpectedConditions.elementToBeClickable(ymnFieldLocator));
        //Click and type ymn
    ...
    public FromExistingPage_Ecomm setArticle(String article) {
        //Wait for element to be available and enter article
        WebElement waitForElement = new WebDriverWait(driver,10).until(ExpectedConditions.elementToBeClickable(articleFieldLocator));
    ...
    public FromExistingPage_Ecomm setShadeCode(String shadeCode) {
        //Wait for element to be available and enter shade code
        WebElement waitForElement = new WebDriverWait(driver,10).until(ExpectedConditions.elementToBeClickable(shadeCodeLocator));
        //Click and type shade code
        Actions clickAndType = new Actions(driver);
        clickAndType.click(driver.findElement(shadeCodeLocator)).build().perform();
        //Wait for search to appear
        WebElement waitForSearch = new WebDriverWait(driver,10).until(ExpectedConditions.visibilityOfElementLocated(shadeCodeSearchLocator));
        clickAndType.sendKeys(driver.findElement(shadeCodeSearchLocator),shadeCode).build().perform();
        //Wait for result to appear, then press enter
        WebElement waitForResult = new WebDriverWait(driver,10).until(ExpectedConditions.visibilityOfElementLocated(shadeCodeResultLocator));
        clickAndType.sendKeys(Keys.ENTER);
        
        return this;
    }
    
    public FromExistingPage_Ecomm setBrand(String brand) {
    ...
    public FromExistingPage_Ecomm setTicket(String ticket) {
        //Wait for element to be available and enter ticket
        WebElement waitForElement = new WebDriverWait(driver,10).until(ExpectedConditions.elementToBeClickable(ticketFieldLocator));
    ...
    public FromExistingPage_Ecomm setFinish(String finish) {
        //Wait for element to be available and enter finish
        WebElement waitForElement = new WebDriverWait(driver,10).until(ExpectedConditions.elementToBeClickable(finishFieldLocator));
    ...
    public FromExistingPage_Ecomm setLength(String length) {
        //Wait for element to be available and enter length
        WebElement waitForElement = new WebDriverWait(driver,10).until(ExpectedConditions.elementToBeClickable(lengthFieldLocator));
    ...
    public FromExistingPage_Ecomm setDateFrom(String dateFrom) {
        return this;
    }
    
    public FromExistingPage_Ecomm setDateTo(String dateTo) {
        return this;
    }
    
    public ManualEntryPage pressLoad() {
