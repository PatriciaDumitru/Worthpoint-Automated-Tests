...
public class AddOrderPage_CCE extends BasePage {
    ...
    public AddOrderPage_CCE(WebDriver passedDriver) {
       super(passedDriver);
    } 
    ...
    public AddOrderPage_CCE setShipToParty(String shipToParty) throws InterruptedException {
        CommonTask.setDropDownField(driver, shipToPartyField, shipToParty);
        return this;
    }
    
    public AddOrderPage_CCE setBusinessPrincipal(String businessPrincipal) throws InterruptedException {
        CommonTask.setDropDownField(driver, busPrincipalField, businessPrincipal);
        return this;
    }
    
    public AddOrderPage_CCE setArticle(String article, int lineNumber) {
    ...
    public AddOrderPage_CCE setBrand(String brand, int lineNumber) throws InterruptedException {
    ...
    public AddOrderPage_CCE setTicket(String ticket, int lineNumber) throws InterruptedException {
    ...
    public AddOrderPage_CCE setShadeCode(String shadeCode,int lineNumber) {
        //Line numbers start from 0
    ...
    public AddOrderPage_CCE setMUMType(String mumType, int lineNumber) {
        //line numbers start from 0
    ...
    public AddOrderPage_CCE setRequestType(String reqType, int lineNumber) {
        //Line numbers start from 0
    ...
    public AddOrderPage_CCE setPurposeType(String purpType, int lineNumber) throws InterruptedException {
        //Line numbers start from 0
    ...
    public AddOrderPage_CCE setQuantity(int quantity, int lineNumber) {
        //Line numbers start from 0
    ...
    public AddOrderPage_CCE pressSubmitExceeded() {
        //Wait for button to be clickable and click
        WebElement waitForButton = new WebDriverWait(driver,10).until(ExpectedConditions.elementToBeClickable(submitOrderButton));
    ...
    public AddOrderPage_CCE pressNewLine(int lineNumber) {
        //Wait for button to be clickable
    ...
    public AddOrderPage_CCE pressCopy(int lineNumber) {
        
        By copyDataButton = By.id("copy_line_item_"+lineNumber);
        
        WebElement waitForButton = new WebDriverWait(driver,10).until(ExpectedConditions.elementToBeClickable(copyDataButton));
    ...
    public AddOrderPage_CCE waitForCopy() {
        Boolean waitForDetails = new WebDriverWait(driver,10).until(ExpectedConditions.not(ExpectedConditions.textToBePresentInElementLocated(purposeField, "Select")));
        return this;
    }
