...
public class OutstandingUploadDraftPage extends BasePage{
    ...
    public OutstandingUploadDraftPage(WebDriver passedDriver) {
        super(passedDriver);
    }
    
    public OutstandingUploadDraftPage setCustomerName(String custName) {
    ...
    public OutstandingUploadDraftPage pressSearch() {
    ...
    public OrderConfirmationPage pressEdit() {
    ...
    public OrderConfirmationPage pressDelete() {
